...
class _$_AuthorModel extends _AuthorModel {
  ...
  @override
  String toString() {
    return 'AuthorModel(id: $id, picture: $picture, firstName: $firstName, lastName: $lastName, content: $content)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, picture, firstName, lastName, content);
...
abstract class _AuthorModel extends AuthorModel {
  factory _AuthorModel(
      ...
      final String content) = _$_AuthorModel;
